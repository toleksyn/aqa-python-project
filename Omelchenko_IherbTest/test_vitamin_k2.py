...
search_results = home_page.search('vitamin k2')
...
product_number = 3
third_product_name = search_results.get_product_name(product_number)
third_product_price = search_results.get_original_product_price(product_number)
third_product = search_results.add_to_cart_in_grid_view(product_number)
