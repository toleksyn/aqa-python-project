...
product_name_in_cart = cart_popup.get_product_name()
product_price_in_cart = cart_popup.get_product_price()

assert fifth_product_name == product_name_in_cart and fifth_product_price == product_price_in_cart
