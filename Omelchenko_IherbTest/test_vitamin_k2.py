...
product_price = search_results_page.get_original_product_price(product_number)
...
product_price_in_cart = cart_page.get_product_price(1)

assert product_name == product_name_in_cart, f'Product names are not equal'
assert product_price == product_price_in_cart, f'Product names are not equal'
